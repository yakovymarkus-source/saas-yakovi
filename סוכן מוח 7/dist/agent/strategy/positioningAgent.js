...
exports.runPositioning = runPositioning;
async function runPositioning(business, market, audience) {
    const tone = business.pricing.amount && business.pricing.amount > 2500
        ? 'premium'
