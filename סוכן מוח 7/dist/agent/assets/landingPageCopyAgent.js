...
exports.runLandingPageCopy = runLandingPageCopy;
async function runLandingPageCopy(blueprint, audience, positioning, offer, feedback = [], attempt = 1) {
    const cta = offer.ctaType === 'book_call' ? 'לקביעת שיחת אבחון' :
