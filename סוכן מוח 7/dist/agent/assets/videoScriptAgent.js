...
exports.runVideoScripts = runVideoScripts;
async function runVideoScripts(business, audience, positioning, offer, feedback = [], attempt = 1) {
    const cta = offer.ctaType === 'book_call' ? 'לקביעת שיחה' :
