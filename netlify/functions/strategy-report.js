...
/**
 * GET /strategy-report?reportId=X  OR  ?jobId=X
 * Returns the full structured strategy report.
 */
exports.handler = async (event) => {
  ...
  let query = supabase.from('strategy_reports').select('*').eq('user_id', user.id);
