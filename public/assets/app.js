    ...
    <div class="auth-container">
      ...
      <div class="auth-card">
        ...
        <form id="auth-form">
          ...
          <button type="button" id="google-signin-btn" style="width:100%;display:flex;align-items:center;justify-content:center;gap:0.6rem;padding:0.65rem 1rem;border:1.5px solid #e2e8f0;border-radius:8px;background:#fff;cursor:pointer;font-size:0.95rem;font-weight:500;color:#1e293b;transition:border-color 0.2s">
